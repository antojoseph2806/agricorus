...
const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({ onClose }) => {
  ...
  const sendOtp = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/forgot-password/send-otp`, {
        method: 'POST',
  ...
  const verifyOtp = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/forgot-password/verify-otp`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const resetPassword = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/forgot-password/reset-password`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },

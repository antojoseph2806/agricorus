  ...
  const fetchLeases = async () => {
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL || "https://agricorus.duckdns.org"}/api/leases/owner/eligible-payments`,
  ...
  const handleRequestPayment = async () => {
    ...
    try {
      const res = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL || "https://agricorus.duckdns.org"}/api/payment-requests/request-payment/${selectedLease}`,

    ...
    const fetchData = async () => {
      try {
        ...
        const [invRes, payoutRes] = await Promise.all([
          axios.get("https://agricorus.duckdns.org/api/project-payments/investments/history", {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get("https://agricorus.duckdns.org/api/payouts/", {
            headers: { Authorization: `Bearer ${token}` },
          }),
        ]);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://agricorus.duckdns.org/api/investor/return-requests",

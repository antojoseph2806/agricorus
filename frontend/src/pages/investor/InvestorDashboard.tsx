  ...
  return (
    <InvestorLayout>
      <div className="p-3 sm:p-4 lg:p-8 bg-gray-50 min-h-screen">
        <div className="bg-gradient-to-r from-emerald-500 to-blue-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 text-white mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">Welcome to Investor Dashboard</h1>

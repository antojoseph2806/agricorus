...
export default function InvestorProjectDetails() {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      ...
      try {
        setPageLoading(true);
        const res = await axios.get(`https://agricorus.duckdns.org/api/projects/investor/${id}`, {
  ...
  const handleInvest = async () => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://agricorus.duckdns.org/api/project-payments/create-order",
      ...
      const options = {
        ...
        handler: async function (response: any) {
          try {
            await axios.post("https://agricorus.duckdns.org/api/project-payments/verify",
            ...
            const updated = await axios.get(`https://agricorus.duckdns.org/api/projects/investor/${project._id}`, { headers: { Authorization: `Bearer ${token}` } });

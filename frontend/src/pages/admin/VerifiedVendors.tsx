...
const VerifiedVendors: React.FC = () => {
  ...
  const fetchVerifiedVendors = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/admin/kyc/verified-vendors?${params}`, {
        headers: {
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">View all verified vendors on the platform</p>
          </div>
          <button
        ...
        <div className="bg-white p-6 rounded-lg shadow border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Total Verified Vendors</p>
              <p className="text-3xl font-bold text-emerald-600">{totalVendors}</p>
            </div>
            ...
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-bold text-gray-900">Verified Vendor Details</h2>
                  <button
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-sm text-gray-900">{selectedVendor.address.street}</p>
                      </div>
                      <div>

...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("https://agricorus.duckdns.org/api/auth/register", {
        method: "POST",
  ...
  const handleVerifyOtp = async (e?: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://agricorus.duckdns.org/api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const res = await fetch("https://agricorus.duckdns.org/api/auth/resend-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },

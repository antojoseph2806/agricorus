...
import { CheckCircleIcon, UserIcon, CalendarIcon, CurrencyRupeeIcon, ArrowTrendingUpIcon } from "@heroicons/react/24/solid";
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 font-medium">Loading ongoing projects...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-sm shadow-sm p-5 mb-6 border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-800">Ongoing Projects</h1>
              <p className="text-gray-600 text-sm">Active projects that have been successfully funded</p>
            </div>
          </div>
        </div>
        ...
        {projects.length === 0 ? (
          <div className="bg-white rounded-sm shadow-sm p-8 text-center border border-gray-200">
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">No ongoing projects</h3>
            <p className="text-gray-500">There are currently no active funded projects.</p>
          </div>
        ) : (
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {projects.map((project) => {
              ...
              return (
                <div key={project._id} className="bg-white rounded-sm shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-200 overflow-hidden group">
                  <div className="p-5">
                    {/* Status Badge */}
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <span className="text-xs text-gray-500">{daysRemaining > 0 ? `${daysRemaining} days left` : 'Ending soon'}</span>
                    </div>

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Monitor successfully funded agricultural initiatives currently in execution</p>
            </div>
          </div>
        </div>
        ...
        {projects.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
            ...
            <p className="text-gray-600">There are currently no active funded projects in progress.</p>
          </div>
        ) : (

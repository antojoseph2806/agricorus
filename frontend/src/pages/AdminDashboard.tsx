...
const Navbar = () => {
  ...
  const navigationItems = [
    { label: 'Manage Users', icon: Shield, href: '/kyc' },
    { label: 'Manage Projects', icon: MapPin, href: '/lands' },
    { label: 'Payments', icon: TrendingUp, href: '/crowdfunding' },
    { label: 'Handle Disputes', icon: ShoppingCart, href: '/marketplace' },
    { label: 'Manage Market', icon: FileText, href: '/agreements' },
    { label: 'Platform Reports', icon: CreditCard, href: '/payments' },
    { label: 'Payments', icon: TrendingUp, href: '/crowdfunding' },
  ];
